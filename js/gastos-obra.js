...
// El módulo "Pagos de obra" (pantalla + cola/agenda editable propia) se sacó
// del panel el 04/09/2026 — Marcelo confirmó que ya no lo usa. Se dejó ESTA
// constante (OBRA_AGENDA_SEED) porque "Gastos Casa" (js/gastos-casa.js) la
// lee directo como base de la lista de proveedores — no borrar sin revisar
// esa dependencia primero. El resto del módulo viejo (obraLeer/obraAgenda/
// obraSeedMerge/renderObraPagos y toda la cola de pagos con su propia
// agenda editable en ceot_obra_agenda/ceot_obra_cola/ceot_obra_hist) se
// borró — no queda ninguna función que lea/escriba esas 3 claves.
