...
// (chequeAcreditado(), index.html — mismo helper que ya usa el resto del
// portal para el criterio "fecha + 48hs"). OSDE/CEM no necesitan este
// filtro: ya vienen gateados por "pendiente" en calcularNetoLocal (c.osde/c.cm
// son 0 hasta que el dato es real, nunca se cargan por adelantado como los
// cheques Colón).
...
function aporteCeotAcreditadoHoy(c) {
  ...
  (c.colonCheques || []).forEach(function(chq) {
    if (chq.monto > 0 && chequeAcreditado(chq.fecha)) {
